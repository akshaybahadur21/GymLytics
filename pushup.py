...
threaded_camera = ThreadedCamera("push.mp4")
...
while True:
    ...
    try:
        ...
        if 12 in idx_to_coordinates and 28 in idx_to_coordinates and 16 in idx_to_coordinates:  # left side of body
            ...
            cv2.line(image, (idx_to_coordinates[11]), (idx_to_coordinates[27]), thickness=4, color=(255, 0, 255))
            cv2.line(image, (idx_to_coordinates[27]), (idx_to_coordinates[15]), thickness=4, color=(255, 0, 255))
    ...
    try:
        ...
        if 12 in idx_to_coordinates and 14 in idx_to_coordinates and 16 in idx_to_coordinates:  # left side of body
            ...
            cv2.line(image, (idx_to_coordinates[11]), (idx_to_coordinates[13]), thickness=4, color=(255, 0, 255))
    ...
    if 0 in idx_to_coordinates:
        cv2.putText(image, "Count : " + str(scount), (idx_to_coordinates[0][0] - 60, idx_to_coordinates[0][1] - 140),
                    fontFace=cv2.FONT_HERSHEY_SIMPLEX,
