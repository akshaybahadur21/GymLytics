...
threaded_camera = ThreadedCamera("squat.mp4")
...
while True:
    ...
    try:
        ...
        cv2.line(image, (int(l2[0][0]), int(l2[0][1])), (int(l2[30][0]), int(l2[30][1])), thickness=4,
                 color=(0, 0, 255))
        ang1 = ang((idx_to_coordinates[24], idx_to_coordinates[26]), (idx_to_coordinates[26], idx_to_coordinates[28]))
        ...
        cv2.line(image, (int(l2[0][0]), int(l2[0][1])), (int(l2[30][0]), int(l2[30][1])), thickness=4,
                 color=(0, 0, 255))
        ang2 = ang((idx_to_coordinates[23], idx_to_coordinates[25]), (idx_to_coordinates[25], idx_to_coordinates[27]))
    ...
    try:
        ...
        cv2.line(image, (int(l2[0][0]), int(l2[0][1])), (int(l2[30][0]), int(l2[30][1])), thickness=4,
                 color=(0, 0, 255))
        eang1 = ang((idx_to_coordinates[12], idx_to_coordinates[14]), (idx_to_coordinates[14], idx_to_coordinates[16]))
        ...
        cv2.line(image, (int(l2[0][0]), int(l2[0][1])), (int(l2[30][0]), int(l2[30][1])), thickness=4,
                 color=(0, 0, 255))
        eang2 = ang((idx_to_coordinates[11], idx_to_coordinates[13]), (idx_to_coordinates[13], idx_to_coordinates[15]))
    ...
    if 0 in idx_to_coordinates:
        cv2.putText(image, "Count : " + str(scount), (idx_to_coordinates[0][0] - 30, idx_to_coordinates[0][1] - 80),
                    fontFace=cv2.FONT_HERSHEY_SIMPLEX,
